...
#define BKLIT_STBY_LEVEL 			125				//Display backlight level when in stand-by (levels are CNT values)
#define BKLIT_INIT_LEVEL 			250				//Display backlight level on startup
