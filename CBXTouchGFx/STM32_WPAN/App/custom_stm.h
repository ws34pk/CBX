...
{
  /* GPS_DATA */
  CUSTOM_STM_MY_GPS_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_MY_GPS_NOTIFY_DISABLED_EVT,
  /* LAT_DATA */
  CUSTOM_STM_LA_DAT_NOTIFY_ENABLED_EVT,
  CUSTOM_STM_LA_DAT_NOTIFY_DISABLED_EVT,
...
/* Exported constants --------------------------------------------------------*/
extern uint16_t SizeMy_Gps;
extern uint16_t SizeLa_Dat;
